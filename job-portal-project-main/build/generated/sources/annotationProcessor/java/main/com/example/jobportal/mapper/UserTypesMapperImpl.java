...
@Component
public class UserTypesMapperImpl implements UserTypesMapper {

    @Override
    public UserTypes fromDTO(UserTypesRequest userTypeRequest) {
        ...
        userTypes.setId( userTypeRequest.getId() );
        userTypes.setUserTypeName( userTypeRequest.getUserTypeName() );

        return userTypes;
    }

    @Override
    public UserTypesResponse toDTO(UserTypes userType) {
        if ( userType == null ) {
            return null;
        }
        ...
        userTypesResponse.setId( userType.getId() );
        userTypesResponse.setUserTypeName( userType.getUserTypeName() );
        userTypesResponse.setUser( userListToUserResponseList( userType.getUser() ) );

        return userTypesResponse;
    }

    @Override
    public List<UserTypesResponse> toDTOs(List<UserTypes> userTypes) {
        if ( userTypes == null ) {
            return null;
        }

        List<UserTypesResponse> list = new ArrayList<UserTypesResponse>( userTypes.size() );
        for ( UserTypes userTypes1 : userTypes ) {
            list.add( toDTO( userTypes1 ) );
        }
    ...
    @Override
    public void mapUpdateRequestToEntity(UserTypes userTypes, UserTypesRequest userTypesRequest) {
        if ( userTypesRequest == null ) {
            return;
        }

        userTypes.setId( userTypesRequest.getId() );
        userTypes.setUserTypeName( userTypesRequest.getUserTypeName() );
    }
